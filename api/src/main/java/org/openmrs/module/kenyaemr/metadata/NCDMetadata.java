...
public class NCDMetadata extends AbstractMetadataBundle {
	...
	public static final class _Form {
		...
		public static final String TELEHEALTH_CONSULTATION_FORM = "32875d86-5f93-40ac-96f0-1dd0db6f8dc3";
	}
	...
	public void install() {
		...
		if (installForms) {
			...
			install(form("Telehealth Consultation Form", null, _EncounterType.NCD_FOLLOWUP, "1", _Form.TELEHEALTH_CONSULTATION_FORM));
		} else {
