...
//                "-- drop missd completely\n" +
    ...
    public CohortDefinition currentlyOnArt() {
        ...
        String sqlQuery="select  e.patient_id\n" +
                ...
                "         ((timestampdiff(DAY,date(latest_tca),date(:endDate)) between 0 and 30 or timestampdiff(DAY,date(latest_tca),date(curdate())) between 0 and 30) and date(latest_vis_date) < date(latest_tca))\n" +
