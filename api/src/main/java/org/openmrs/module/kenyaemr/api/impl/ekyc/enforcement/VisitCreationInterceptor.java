...
@Component
public class VisitCreationInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest req, HttpServletResponse resp, Object handler)
        ...
        if (req.getRequestURI().contains("/ws/rest/v1/visit") && "POST".equalsIgnoreCase(req.getMethod())) {
            ...
            try {
                enforcement.assertCheckinVerified(patientUuid);
