...
@Component
@Builds({"kenyaemr.covid.report.everDischargedFromCovidLineList"})
public class PatientsEverDischargedFromCovidReportBuilder extends AbstractHybridReportBuilder {
