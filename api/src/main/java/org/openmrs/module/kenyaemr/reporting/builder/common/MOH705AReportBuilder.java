...
public class MOH705AReportBuilder extends AbstractReportBuilder {
	...
	static final int EAR_INFECTION = 149609;
	...
	protected DataSetDefinition moh705ADataset() {
		...
		ReportingUtils.addRow(cohortDsd,"URC","Upper Respiratory Tract Infections", ReportUtils.map(moh705indicatorLibrary.diagnosis(DiagnosisLists.getUpperPeadRespiratoryTractInfectionsList(), AGE_BELOW_FIVE), indParams),ReportAddonUtils.getAdultChildrenColumns());
		ReportingUtils.addRow(cohortDsd, "LTI", "Lower Respiratory Tract Infections", ReportUtils.map(moh705indicatorLibrary.diagnosis(DiagnosisLists.getLowerPeadRespiratoryTractInfectionsList(),AGE_BELOW_FIVE), indParams), ReportAddonUtils.getAdultChildrenColumns());
		...
		ReportingUtils.addRow(cohortDsd,"SMC", "Suspected Malaria", ReportUtils.map(moh705indicatorLibrary.labTestForSuspectedMalaria(DiagnosisLists.getTestedMalariaConcepts(), AGE_BELOW_FIVE), indParams), ReportAddonUtils.getAdultChildrenColumns());
		...
		ReportingUtils.addRow(cohortDsd,"EIC","Ear Infections Conditions", ReportUtils.map(moh705indicatorLibrary.diagnosis(Arrays.asList(EAR_INFECTION),AGE_BELOW_FIVE), indParams),	ReportAddonUtils.getAdultChildrenColumns());
