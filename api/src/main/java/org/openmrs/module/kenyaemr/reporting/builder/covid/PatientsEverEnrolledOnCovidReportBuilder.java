...
import org.openmrs.module.kenyaemr.reporting.cohort.definition.covid.PatientsEverEnrolledOnCovidCohortDefinition;
...
@Component
@Builds({"kenyaemr.covid.report.everEnrolledOnCovidLineList"})
public class PatientsEverEnrolledOnCovidReportBuilder extends AbstractHybridReportBuilder {
    public static final String DATE_FORMAT = "dd/MM/yyyy";

    @Override
    protected Mapped<CohortDefinition> buildCohort(HybridReportDescriptor descriptor, PatientDataSetDefinition dsd) {
        return everEnrolledOnCovidCohort();
    }

    protected Mapped<CohortDefinition> everEnrolledOnCovidCohort() {
        CohortDefinition cd = new PatientsEverEnrolledOnCovidCohortDefinition();
        cd.addParameter(new Parameter("startDate", "Start Date", Date.class));
        cd.addParameter(new Parameter("endDate", "End Date", Date.class));
        cd.setName("CovidLineList");
    ...
    protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor descriptor, ReportDefinition report) {
        ...
        PatientDataSetDefinition covidLineList = covidDataSetDefinition();
        covidLineList.addRowFilter(everEnrolledOnCovidCohort());
        DataSetDefinition everEnrolledOnCovidDSD = covidLineList;

        return Arrays.asList(
                ReportUtils.map(everEnrolledOnCovidDSD, "startDate=${startDate},endDate=${endDate}")
        );
    }
